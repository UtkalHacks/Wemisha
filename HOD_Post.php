...
<html>
  ...
  <head>
    <title>FRIENDZY | HOD My Post</title>
    <style type="text/css">
  ...
  <?php
    ...
    $query="select d_name from department_details where d_id='$d_id'";
    $result=mysqli_query($con,$query);
    if($result)
    {
       $row_count=mysqli_num_rows($result);
	...
	<div class="backimg">
       ...
       <div class="main-section">
         <div class="request-tab">
            <nav>
              <ul class="tab-items">
                 <li><a class="tab-hov" href="./HOD_Home.php">Timeline</a></li>
         ...
         <div class="show-post">
          ...
          $query="select * from post_details where p_id='$d_id' order by p_no desc";
          $result=mysqli_query($con,$query);
       ...
       <div class="post-area">
            ...
            <form action="./HOD_Approve_Request.php">
               <input class="btn" type="submit" value="Approval Section">
            </form>
     ...
     { 
      ...
      if(($p_text=="" and $file_tmp==""))
        { 
           ...
           mysqli_close($con);
           echo '<script type="text/javascript"> location.href="./HOD_Post.php"</script>';
        }
      else
        { 
            ...
            if(($file_tmp!="") and (!($file_type=="image/jpeg" or $file_type=="image/jpg" or $file_type=="image/png")))
              ...
              { 
                ...
                if($file_tmp!="")
                {
                 ...
                 $query="insert into post_details (p_text,p_image,p_id,date_time) values ('{$p_text}','{$p_image}','{$d_id}','{$date_time}') ";
                 $result=mysqli_query($con,$query);
              ...
              if(isset($_POST['btn_delete']))
                 { 
                  ...
                  if($d_no=="")
                     ...
                     { 
                         $query="select * from post_details where p_id='$roll_no' and p_no='$d_no'";
                         $result=mysqli_query($con,$query);
                         if($result)
                         {
                          $row_count=mysqli_num_rows($result);
                          ...
                          mysqli_close($con);
                          echo '<script type="text/javascript"> location.href="./Student_Post.php"</script>';
