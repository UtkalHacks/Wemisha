...
<html>
  ...
  ?>
	...
	<div class="backimg">
      <div class="view-form" >
         <p id="lbl" align="center">Edit HOD Profile</p>
                   ...
                   if(in_array($image_file_type,$extention_arr))
                     {
                        ...
                        $query="update hod_details set profile_pic='$image' where d_id='$id'";
                        $result=mysqli_query($con,$query);
                        ...
                        if($result)
                        {
                           ...
                           mysqli_close($con);
                           echo '<script type="text/javascript"> location.href="./HOD_Edit.php"</script>';
                        }
                     }
                    else
         ...
         <?php
            if(isset($_POST['btn_remove']))
            {
               ...
               if($img!="")
                   {
                     $query="update hod_details set profile_pic='' where d_id='$id'";
                     $result=mysqli_query($con,$query);
                     if($result)
                        {
     ...
     if(isset($_POST['btn_save']))
       {
         ...
         $query="update hod_details set f_name='$f_name',m_name='$m_name',l_name='$l_name',email='$email',phone='$phone',gender='$gender' where d_id='$id'";
         $result=mysqli_query($con,$query);
         if($result)
           {
             echo '<script type="text/javascript"> alert("Details Saved Successfully.") </script>';
             echo '<script type="text/javascript"> location.href="./HOD_View.php"</script>';
           }
         else
