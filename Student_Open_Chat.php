       ...
       <div class="main-section">
        ...
        <div class="request-tab">
              ...
              if($result)
                { 
                   while($row=mysqli_fetch_assoc($result))
                   {
                    ...
                    $message=$row['message'];
                    if($sender==$roll_no && $reciever==$id)
                     echo "<div class='sender'><p class='message'>$message</p></div>";
                    else if($sender==$id && $reciever==$roll_no)
         ...
         <div class="accept-request">
             <form action="./Student_Open_Chat.php" method="post">
             <table>
                <tr>
   ...
   if(isset($_POST['btn_send']))
      {
         ...
         if($message!="")
          { 
            ...
            $query="insert into chat_details(sender,reciever,message,date_time) values('{$roll_no}','{$id}','$message','$date_time')";
            $result=mysqli_query($con,$query);
            if($result)
            {
