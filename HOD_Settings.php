...
<html>
  ...
  <head>
    <title>FRIENDZY | HOD Settings</title>
    <style type="text/css">
...
<?php
     ...
     { 
      ...
      if(($p_text=="" and $file_tmp==""))
        { 
           ...
           mysqli_close($con);
           echo '<script type="text/javascript"> location.href="./HOD_Settings.php"</script>';
        }
      else
        { 
                ...
                if($file_tmp!="")
                {
                 ...
                 $result=mysqli_query($con,$query);
                  ...
                  if($result)
                        {
                           mysqli_close($con);
                           echo '<script type="text/javascript"> location.href="./HOD_Home.php"</script>';
                        }
  ...
  if(isset($_POST['btn_change']))
  {
    ...
    if($id=="" || $c_new_id==""|| $c_new_id=="")
      ...
      { 
         $query="select * from hod_details where d_id='$d_id' and password='$id'";
         $result=mysqli_query($con,$query); 
         if($result)
         {
          $row_count=mysqli_num_rows($result);
         ...
         $query="update hod_details set password='$new_id' where d_id='$d_id'";
         $result=mysqli_query($con,$query);
         if($result)
            {
             session_destroy();
