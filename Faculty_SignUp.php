...
<html>
 ...
 <head>
    <title>FRIENDZY | Faculty Sign Up</title>
  ...
  <body>
    ...
    <div class="form">
           ...
           <form name="form_stud_reg" id="reg" action="" method="post" onsubmit="">
               <table id="treg">
                  ...
                  <tr><td id="label">Faculty ID:<span class="req">*</span></td><td><input class="textbox" type="text" name="txt_fac_id"></td></tr>
...
<?php
                ...
                if(isset($_POST['btn_sign_up'])) 
                {
                   ...
                   $fac_id=test_input($_POST['txt_fac_id']);
                   ...
                   if($f_name==null||$l_name==null||$fac_id==null||$gender==null||$password==null||$c_password==null)
                   {
                   ...
                   else
                   {
                         ...
                         if($check_id==1)
                             echo '<script type="text/javascript"> alert("Registration with the given Faculty ID already exist.") </script>';
                         
                         else
                          {
                            $query="insert into faculty_details(f_name,m_name,l_name,f_id,email,phone,gender,reg_status,password) values('{$f_name}','{$m_name}','{$l_name}','{$fac_id}','{$email}','{$phone}','{$gender}','{$reg_status}','{$password}')";
                            if (mysqli_query($con,$query))
                                echo '<script type="text/javascript"> alert("Your Registration has been sent to your respective HOD for Approval. Once approved you cal login with your Faculty ID and Password. You can check your Registration Status from the Status Tab Section.") </script>';
                          }
                         mysqli_close($con);
                   }
