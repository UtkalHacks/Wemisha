...
<html>
 ...
 <head>
    <title>FRIENDZY | Student Status</title>
	...
	<div class="backimg">
		...
		<div class="form">
           ...
           <form name="stud_view_reg" action="" method="post" onsubmit="">
               <table id="tstat">
               <tr><td id="label">Roll No:</td><td><input class="textbox" type="text" name="txt_view"></td></tr>
               </table>
...
<?php
              if(isset($_POST['btn_check']))
              {
                 ...
                 if($view==null)
                    echo '<script type="text/javascript"> alert("Please enter a Roll No to check Registration Status.") </script>';
                 
                 else
                   {
                      $query="select roll_no,reg_status from student_details where roll_no='$view'";
                           ...
                           if($row_count==1)
                            {
                              ...
                              echo '<script type="text/javascript"> alert("Sorry Roll No does not exist.") </script>';
